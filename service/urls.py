...
urlpatterns = [
    ...
    path("client/orders/<uuid:public_id>/", views.client_order, name="client_order"),
    path("client/orders/<uuid:public_id>/forget/", views.client_forget_order, name="client_forget_order"),
    path(
        "client/orders/<uuid:public_id>/estimate/approve/",
        views.client_estimate_approve,
        name="client_estimate_approve",
    ),
    path(
        "client/estimate/approve/",
        views.client_estimate_approve_legacy,
        name="client_estimate_approve_legacy",
    ),
    path("portal/order/", views.client_portal, name="client_portal_legacy"),
